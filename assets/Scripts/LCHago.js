(function (f) { if (typeof exports === "object" && typeof module !== "undefined") { module.exports = f() } else if (typeof define === "function" && define.amd) { define([], f) } else { var g; if (typeof window !== "undefined") { g = window } else if (typeof global !== "undefined") { g = global } else if (typeof self !== "undefined") { g = self } else { g = this } g.LCHago = f() } })(function () {
        ...
        1: [function (require, module, exports) {
            ...
            var Client = (function () {
                ...
                Client.prototype.connect = function (mode) {
                    hagoDelegate_1.hagoDelegate.onPKLoading();
                ...
                Client.prototype.result = function (data) {
                    ...
                    var result = {
                        ...
                        nonstr: data.nonstr,
                        sign: data.sign,
                        resultrawdata: data.resultrawdata,
                        result: JSON.parse(data.resultrawdata)
                    };
                    setTimeout(function () {
                        console.log("hagoDelegate.onPKFinish");
                        hagoDelegate_1.hagoDelegate.onPKFinish(JSON.stringify(result));
                    }, 3000);
                };
                return Client;
            }());
            ...
            var HagoDelegate = (function () {
                ...
                HagoDelegate.prototype.onPKLoading = function () {
                    if (isHago) {
                        hago.onPKLoading();
                    }
                };
                ...
                HagoDelegate.prototype.onPKLoadFail = function () {
                    if (isHago) {
                        hago.onPKLoadFail();
                    }
                };
                ...
                HagoDelegate.prototype.onGameExit = function () {
                    if (isHago) {
                        hago.onGameExit();
                    }
                };
                HagoDelegate.prototype.getUserInfo = function (params) {
                    if (isHago) {
                        hago.getUserInfo(params);
                    }
                };
                HagoDelegate.prototype.setEnterBackgroundCallback = function (cb) {
                    if (isHago) {
                        hago.setEnterBackgroundCallback(cb);
                    }
                };
                HagoDelegate.prototype.setEnterForegroundCallback = function (cb) {
                    if (isHago) {
                        hago.setEnterForegroundCallback(cb);
                    }
                };
                HagoDelegate.prototype.setGameExitCallback = function (cb) {
                    if (isHago) {
                        hago.setGameExitCallback(cb);
                    }
                };
                HagoDelegate.prototype.setGameReadyCallback = function (cb) {
                    if (isHago) {
                        hago.setGameReadyCallback(cb);
                    }
                };
                HagoDelegate.prototype.getDeviceInfo = function (params) {
                    if (isHago) {
                        hago.getDeviceInfo(params);
                    }
                };
                return HagoDelegate;
            }());
