...
export class EventMgr {
    private static singleInstance: EventMgr = null;
    public static getInst(): EventMgr {
        if (EventMgr.singleInstance == null) {
            EventMgr.singleInstance = new EventMgr();
        }
        return EventMgr.singleInstance;
    }
